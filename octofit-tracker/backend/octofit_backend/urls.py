...
from .views import UserProfileDetailView, ActivityLogListCreateView, ActivityLogDetailView

urlpatterns = [
    path("admin/", admin.site.urls),
    path('profile/', UserProfileDetailView.as_view(), name='user-profile-detail'),
    path('activities/', ActivityLogListCreateView.as_view(), name='activity-log-list-create'),
